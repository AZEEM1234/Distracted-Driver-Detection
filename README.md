...
Kaggle's Dataset.So thats why the accuracy is around 13% but when we had tested the dataset with
...
![left](./test.PNG) #Own dataset accuracy |
![center](./test1.PNG) #Combined dataset contining our own dataset and trained dataset
